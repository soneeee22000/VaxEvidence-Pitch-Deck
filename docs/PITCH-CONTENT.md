...
**Founder quote:** After 13 years leading vaccine RWE at Pfizer, Dr. Tin Tin Htar Myint knows firsthand — every effectiveness study is still a 6-month marathon of manual work.
...
| Feature                     | Description                                                                                                                             |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **Protocol Builder**        | PICO-based protocol design with versioning, side-by-side diff viewer, digital signatures, and immutable audit trail                     |
...
| **Regulatory Export**       | FDA IND templates (21 CFR 312.23), eCTD Module 5 (ICH M4E(R2)), CDISC/SDTM datasets, CONSORT/STROBE/GCP compliance checklists           |
...
## Slide 5: What's Built — Fully Built Platform
...
- **Regulatory Compliance:** FDA IND and eCTD export templates, CDISC/SDTM datasets, CONSORT/STROBE/GCP compliance checklists
...
| Regulatory exports | Limited                          | Regulatory export templates (IND, eCTD, SDTM) |
...
## Slide 9: Team — Strong Founder-Market Fit
...
1. **Domain Expertise** — Dr. Tin Tin lived the problem for 15 years in vaccine RWE
